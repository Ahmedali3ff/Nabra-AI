          ...
          <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center gap-8">
            ...
            <div className="flex w-full flex-col items-stretch justify-center gap-4 pt-2 sm:w-auto sm:flex-row sm:items-center">
              <button
                ...
                className="min-h-[52px] rounded-xl bg-[#53e894] px-8 py-4 text-base font-bold text-black shadow-lg shadow-[#53e894]/20 transition duration-200 hover:scale-[1.02] hover:bg-[#69f7a7] active:scale-[0.98]"
              >
                Claim Your Voice
              </button>
            </div>
              ...
              <div className="relative h-72 md:h-full md:min-h-[430px]">
                <div className="absolute inset-0 bg-[#2a2a2a]/50">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span
                      className="material-symbols-outlined text-6xl text-[#53e894]/30 sm:text-7xl"
                      aria-hidden="true"
                    >
                      analytics
                    </span>
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-sm text-[#e5e2e1]">
                  <span
                    className="material-symbols-outlined text-[18px] text-[#53e894]"
                    aria-hidden="true"
                  >
                    check_circle
                  </span>
            ...
            >
              ...
              <div className="flex flex-col gap-4 md:w-2/3 md:flex-row md:overflow-x-auto md:pb-0">
                <div className="relative aspect-square w-full overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] md:w-auto md:min-w-[200px]">
                  ...
                  />
                  <span
                    className="material-symbols-outlined absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-4xl text-[#53e894]/20"
                    aria-hidden="true"
                  >
                    face
                  </span>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left space-y-3">
                ...
                <p className="text-sm leading-relaxed text-[#bbcabc]">
                  Created VoiceForge under the MIT License to redefine assistive
                  communication. Get in touch directly via phone, WhatsApp, or
                  email, or connect across social channels.
                </p>
        ...
        <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
          ...
          >
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <button
                onClick={() => onNavigate?.("onboarding")}
                className="inline-flex min-h-[52px] items-center justify-center gap-3 rounded-xl bg-[#53e894] px-8 py-4 text-base font-bold text-black transition duration-200 hover:scale-[1.02] hover:bg-[#69f7a7] active:scale-[0.98]"
              >
                Claim Your Voice
                <span className="material-symbols-outlined" aria-hidden="true">
                  arrow_forward
              ...
              <button
                ...
                className="min-h-[52px] rounded-xl bg-white/10 px-8 py-4 text-base font-semibold text-[#e5e2e1] transition duration-200 hover:bg-white/15 active:scale-[0.98]"
              >
                Technical Specs
              </button>
            </div>
