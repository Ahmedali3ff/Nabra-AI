...
import { Phone, Mail, MessageCircle, ExternalLink, Globe, Shield, Heart } from "lucide-react";
    ...
    <footer className="border-t border-ink/10 bg-white/80 backdrop-blur-md dark:border-border dark:bg-black/90 text-ink dark:text-neutral-200 transition-colors">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12 items-center">
          ...
          <div className="md:col-span-5 flex items-center gap-4">
            <div className="relative group shrink-0">
              ...
              />
              <span className="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full bg-emerald-500 ring-2 ring-white dark:ring-black" title="Online / Available" />
            </div>
            <div>
              ...
              <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                Created with <Heart size={11} className="inline text-rose-500 fill-rose-500 mx-0.5" /> by{" "}
                <a
        ...
        <div className="mt-6 border-t border-ink/5 pt-4 dark:border-white/5 flex flex-col sm:flex-row items-center justify-between text-[11px] text-neutral-400 gap-2">
          <p>© {currentYear} VoiceForge. All rights reserved. Open source under MIT License.</p>
          <div className="flex items-center gap-4">
            <span>Author: <strong className="text-neutral-600 dark:text-neutral-300">Avdhesh Kumar Dadhich</strong></span>
            <span>Tel: <a href="tel:+917690863039" className="hover:underline text-neutral-600 dark:text-neutral-300">+91 7690863039</a></span>
          </div>
        </div>
