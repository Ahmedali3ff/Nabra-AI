    ...
    <div ref={containerRef} className="relative" onKeyDown={handleKeyDown}>
      <button
        ...
        className={[
          ...
          isOpen
            ? "border-moss bg-mint/20 text-ink"
            : "border-neutral-200 bg-white text-neutral-700 hover:border-moss/50",
        ].join(" ")}
      >
      ...
      {isOpen && (
        <div
          ...
          className={[
            ...
            dropdownUp
              ? "bottom-full mb-2 animate-fade-in-down"
              : "mt-2 animate-fade-in-up",
        ...
        >
          <div className="flex items-center gap-2 border-b border-neutral-100 px-3 py-2.5">
            ...
            <input
              ...
              aria-activedescendant={
                focusIndex >= 0 ? getOptionId(focusIndex) : undefined
              }
              type="text"
              value={search}
              onChange={(e) => {
          ...
          >
            {flatItems.map((item, index) => {
              if (item.type === "header")
                return (
                  <li
                    key={`r-${item.region}`}
                    role="presentation"
                    className="sticky top-0 bg-neutral-50 px-4 py-2 text-[10px] font-bold uppercase text-neutral-400"
                  >
                    {item.region}
                  </li>
                );
              ...
              const isSelected =
                item.type === "auto" ? !value : value === item.code;
              return (
                <li
                  key={item.code || "auto"}
